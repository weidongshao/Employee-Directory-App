    ...
    return (
      <ScrollView contentContainerStyle={styles.contentContainer}>
        ...
        <TouchableOpacity style={styles.textContainer}
          onPress={() => Communications.phonecall(this.props.employee.officePhone, true)}>
        ...
        <View style={styles.separator} />
        <TouchableOpacity style={styles.textContainer}
          onPress={() => Communications.phonecall(this.props.employee.mobilePhone, true)}
          >
          <Text>Call Cell</Text>
          <Text>
        ...
        <View style={styles.separator} />
        <TouchableOpacity style={styles.textContainer}
          onPress={() => Communications.text(this.props.employee.mobilePhone)}>
          <Text>SMS</Text>
          <Text>
            {this.props.employee.mobilePhone}
          </Text>
        ...
        <View style={styles.separator} />
        <TouchableOpacity style={styles.textContainer}
          onPress={() => Communications.email([this.props.employee.email],null,null,null,null)}>
          <Text>Email</Text>
          <Text>
